...
interface ApiInterface {
    ...
    @GET("user/chat/private/{myUserId}/to/{receiveUs}")
    fun getPrivateMessage(@Path("myUserId") myUserId: String, @Path("receiveUs") receiveUs: String): Deferred<JsonArray>
    @POST("user/private-chat-message")
    fun postSendMessage(@Body chatData: Chat): Deferred<Void>
}